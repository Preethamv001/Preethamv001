...
🔭 Currently
Working on a Full‑Stack .NET application (Angular + .NET backend).
Improving UI/UX skills and building portfolio pieces.

💡 Highlights
Frameworks: Angular, ASP.NET Core
Languages: C#, TypeScript, SQL, JavaScript, HTML, CSS
Cloud / DevOps: AWS, Azure, CI/CD pipelines (GitHub Actions / Azure DevOps)
Interest: UI/UX design, front-end accessibility and performance

🚀 Featured Projects
Project Name 1 — Short one-line description of what it does and tech used.
Project Name 2 — Short one-line description and notable features.
Project Name 3 — Short one-line description and link to demo if available.
Replace the above links with your actual project repos and a one-line summary for each project.
...
📫 Contact
Email: your.email@example.com — replace with your email for a working mailto badge.
LinkedIn: https://www.linkedin.com/in/your-profile — replace with your profile link.
Portfolio / Resume: https://your-portfolio.example.com — add link if available.
...
I’m looking for opportunities in UI/UX and front-end engineering roles.
Happy to collaborate on open-source UI/UX projects or contribute to .NET libraries.
